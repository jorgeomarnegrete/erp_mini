...
def _query_bajo_stock_minimo(db: Session, categoria_id: int | None = None, subfamilia_id: int | None = None):
...
def get_bajo_stock_minimo(db: Session, categoria_id: int | None = None, subfamilia_id: int | None = None):
    """Lista productos activos por debajo del stock mínimo, opcionalmente filtrados por familia y/o subfamilia"""
    return _query_bajo_stock_minimo(db, categoria_id=categoria_id, subfamilia_id=subfamilia_id).order_by(Producto.nombre.asc()).all()
