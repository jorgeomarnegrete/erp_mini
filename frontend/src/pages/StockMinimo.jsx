    ...
    try {
      ...
      if (pdfWindow) {
        pdfWindow.document.write(`
          <html>
            <head>
              <title>Visor PDF - Reporte de Stock Mínimo</title>
    ...
    <div className="max-w-2xl mx-auto py-8">
      {!isModalOpen && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
          ...
          <h2 className="text-xl font-black text-gray-800 mb-2">Reporte de Stock Mínimo</h2>
          <p className="text-gray-500 font-medium mb-6">Generá un PDF con los productos que están por debajo de su stock mínimo configurado.</p>
          <button
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 bg-gray-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md border-t-8 border-orange-500">
            ...
            <div className="p-6">
              ...
              <button
                ...
                disabled={isPrinting}
                className="w-full bg-orange-500 hover:bg-orange-600 text-white px-4 py-3 rounded-xl font-bold shadow-sm flex items-center justify-center transition-all disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {isPrinting ? (
